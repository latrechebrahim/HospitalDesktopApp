...
class TextEditView extends StatefulWidget {
  ...
  const TextEditView({
    ...
    this.firstDate,
    this.lastDate, required this.isMode,
  })  : assert(
            ...
            children: [
              ...
              CompositedTransformTarget(
                ...
                child: TextField(
                  ...
                  style: TextStyle(color: AppTheme.getModeColor(AppTheme.lightBlue1, AppTheme.lightWhite, isMode),),
                        ...
                        ? (widget.onSuffixPress != null
                            ? _buildIconButton(
                                ...
                                color: _isFocused
                                    ...
                                    : AppTheme.getModeColor(AppTheme.lightGray, AppTheme.darkGray, isMode),
                              )
                            : Icon(
                                widget.suffixIcon,
                                color:_isFocused
